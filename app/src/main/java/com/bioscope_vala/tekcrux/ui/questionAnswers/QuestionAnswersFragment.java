...
public class QuestionAnswersFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        mQuestionAnswersViewModel =
                ViewModelProviders.of(this).get(QuestionAnswersViewModel.class);
        View root = inflater.inflate(R.layout.fragment_question_answer, container, false);
        final TextView textView = root.findViewById(R.id.text_question_answer);
        mQuestionAnswersViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
